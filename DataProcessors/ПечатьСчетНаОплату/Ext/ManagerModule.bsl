...
Функция ДоработкиПечатныхФорм_СформироватьПФ_Изменение(ОписаниеПечатнойФормы, ДанныеОбъектовПечати, ОбъектыПечати, ВывестиПланОплаты)
...
// Здесь можно описать новое поведение.
			ДанныеПечати.Вставить("ОтветственныйЗаОформлениеДокумента", ДанныеОбъекта.Автор);
...
Функция ДоработкиПечатныхФорм_СформироватьПФ(ОписаниеПечатнойФормы, ДанныеОбъектовПечати, ОбъектыПечати, ВывестиПланОплаты)
	// Вставить содержимое метода.
//	Результат = ПродолжитьВызов(ОписаниеПечатнойФормы, ДанныеОбъектовПечати, ОбъектыПечати, ВывестиПланОплаты);
	Результат = ДоработкиПечатныхФорм_СформироватьПФ_Изменение(ОписаниеПечатнойФормы, ДанныеОбъектовПечати, ОбъектыПечати, ВывестиПланОплаты);
	Возврат Результат;
КонецФункции
